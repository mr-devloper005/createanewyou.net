export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'createanewyou',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Createanewyou',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'createanewyou.net',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://createanewyou.net',
